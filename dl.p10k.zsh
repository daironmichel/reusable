# Generated by Powerlevel10k configuration wizard on 2021-02-02 at 10:46 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{red}%F{yellow}'
  ...
  function prompt_venv_name() {
    p10k segment -f 'cyan' -c '$VIRTUAL_ENV' -e -t '("$(basename $(dirname $VIRTUAL_ENV))")'
  }
